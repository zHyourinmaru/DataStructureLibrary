...
public:
  ...
  // Move assignment
  DictionaryContainer& operator=(DictionaryContainer&&) noexcept = default; // Move assignment of abstract types should not be possible.

  /* ************************************************************************ */

  // Comparison operators
  DictionaryContainer& operator==(const DictionaryContainer&) const noexcept = delete; // Comparison of abstract types might not be possible.
  DictionaryContainer& operator!=(const DictionaryContainer&) const noexcept = delete; // Comparison of abstract types might not be possible.
...
public:
  ...
  //MapFunctor è la funzione da applicare ad ogni valore: leggerà un dato (Data&) ed avrà un parametro (void*)
  typedef std::function<void(Data&, void*)> MapFunctor;

  //MapFunctor è la funzione da applicare ad ogni valore, ha lo stesso parametro del tipo
...
public:
  ...
  //FoldFunctor permette la lettura dei dati: si indica con cosa far partire il calcolo, un offset (const void*) e si indica un ulteriore parametro aggiuntivo void*.
...
public:
  ...
  // Move assignment
  PreOrderFoldableContainer& operator=(PreOrderFoldableContainer&&) noexcept; // Move assignment of abstract types should not be possible.
